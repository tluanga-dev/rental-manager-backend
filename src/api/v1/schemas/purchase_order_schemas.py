...
class PurchaseOrderLineItemCreateSchema(BaseModel):
    ...
    tax_amount: Decimal = Field(default=Decimal("0.00"), ge=0, decimal_places=2, description="Tax amount")
    ...
    rental_rate: Decimal = Field(default=Decimal("0.00"), ge=0, decimal_places=2, description="Rental rate")
    replacement_cost: Decimal = Field(default=Decimal("0.00"), ge=0, decimal_places=2, description="Replacement cost")
    late_fee_rate: Decimal = Field(default=Decimal("0.00"), ge=0, decimal_places=2, description="Late fee rate")
    ...
    selling_price: Decimal = Field(default=Decimal("0.00"), ge=0, decimal_places=2, description="Selling price")
