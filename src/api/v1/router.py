...
from .endpoints.purchase_transactions import router as purchase_transactions_router
...
from .endpoints.sales_transactions import router as sales_transactions_router
from .endpoints.sales_returns import router as sales_returns_router
...
api_router.include_router(purchase_transactions_router)
...
api_router.include_router(sales_transactions_router)
api_router.include_router(sales_returns_router)