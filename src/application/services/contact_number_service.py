...
class ContactNumberService:
    ...
    async def get_contact_number(self, contact_id: UUID) -> Optional[ContactNumber]:
    ...
    async def get_entity_contact_numbers(self, entity_type: str, entity_id: UUID) -> List[ContactNumber]:
    ...
    async def delete_contact_number(self, contact_id: UUID) -> bool:
